...
buildPerson(plainPerson, "Timmy", 21);

var completePerson = buildPerson(plainPerson, "Timmy", 21);
 ...
 */
      function detectingTranmission(obj){
        if(obj.automaticTransmission === true){
          return "It's automatic son";
        }else{
          return "Hard Labor kid";
        }
      }
...
var displayNewPassengers = addPassengers(stockCar, passengerList, passengerAges);

console.log(displayNewPassengers);
